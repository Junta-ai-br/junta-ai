    ...
    <main className="page">
      <div className="page__container">
        <header className="page__header">
          <span className="page__eyebrow">Privacidade</span>
          ...
          <p className="page__description">
            O junta.ai, tem o compromisso de proteger a privacidade e a segurança dos dados pessoais dos usuários dos nossos serviços. Esta Política de Privacidade explica como coletamos, utilizamos, armazenamos e compartilhamos suas informações pessoais.
          </p>
        </header>
        ...
        <div className="page__content">
          <section className="page__section">
            ...
            <p>
              ...
              Dados de Identificação: Nome, número de telefone, e-mail, e outras informações necessárias para o cadastro.
              Dados Financeiros: Informações sobre despesas, receitas, contas a pagar, e outras informações financeiras que você fornecer.
              Dados de Uso: Informações sobre como você utiliza o serviço, incluindo interações com o chatbot, preferências de categorização e uso das funcionalidades.
              Dados Técnicos: Informações sobre o dispositivo utilizado, endereço IP, logs de acesso e outros dados de conexão.
            </p>
            ...
            <p>
              ...
              Prestação de Serviços: Para fornecer, personalizar e melhorar os serviços do junta.ai.
              Categorização e Análise: Para categorizar automaticamente suas despesas e fornecer insights financeiros.
              Segurança: Para garantir a segurança e integridade dos nossos serviços, incluindo prevenção de fraudes.
              Comunicação: Para entrar em contato com você em relação ao uso do serviço, incluindo notificações e suporte.
              Cumprimento Legal: Para cumprir obrigações legais e regulatórias aplicáveis.
            </p>
            ...
            <p>
              ...
              Acessar seus dados pessoais: Solicitar uma cópia dos dados pessoais que mantemos sobre você.
